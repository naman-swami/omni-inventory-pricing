---
name: promotional-cannibalization-check
description: Quantifying how promotional discounting on one product impacts adjacent category margins.
---

# promotional-cannibalization-check
...
```json
{
  "skill": "promotional-cannibalization-check",
  "status": "completed",
  "confidence": 0.95,
  "findings": []
}
